...
type SystemConfiguration struct {
	...
	Data string `default:"/mnt/user/appdata/pelican-wing/data" json:"-" yaml:"data"`

	// Directory where server archives for transferring will be stored.
	ArchiveDirectory string `default:"/mnt/user/appdata/pelican-wing/data/archives" json:"-" yaml:"archive_directory"`

	// Directory where local backups will be stored on the machine.
	BackupDirectory string `default:"/mnt/user/appdata/pelican-wing/data/backups" json:"-" yaml:"backup_directory"`
	...
	User struct {
		...
		Passwd struct {
			...
			Directory string `json:"directory" yaml:"directory" default:"/tmp/pelican"`
	...
	MachineID struct {
		...
		Directory string `json:"directory" yaml:"directory" default:"/tmp/pelican/machine-id"`
